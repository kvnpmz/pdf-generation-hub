...
{
    private static void RenderBullet(this IContainer container, ReportTheme theme)
    {
        container
             .AlignMiddle()
             ...
             .CornerRadius(theme.BulletSize / 2f)
             .BorderColor(theme.PrimaryColor)
             .Background(theme.PrimaryColor)
             ;
    }

    public static IContainer ColumnBox(IContainer c, string bg, ReportTheme t, string? border = null)
    {
        ...
        return c
            ...
            .Background(bg)
            .PaddingVertical(t.ColumnPadding)
            .PaddingHorizontal(t.ColumnPadding + 3f)
            ;
    }
