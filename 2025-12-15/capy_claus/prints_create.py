...
# ==== CHECK CLI ARGUMENT ====
if len(sys.argv) < 2:
    print("Usage: python3 generate_etsy_pngs_zip_cli.py <input_image>")
    sys.exit(1)
...
zip_name = os.path.splitext(os.path.basename(input_image))[0] + "_pngs.zip"

# Remove old folder/zip if they exist
...
print(f"\nOriginal + {len(common_sizes)} PNGs generated and zipped into {zip_name}")
