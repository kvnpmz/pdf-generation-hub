...
BLUE = colors.HexColor('#74966D')
LIGHT_BLUE = colors.HexColor('#BACBB7')
SKY_BLUE = colors.HexColor('#F5F5F5')

def create_budget_pdf(filename="green_budget_template.pdf"):
    """
    ...
    for category in categories:
        table_data.append([
            Paragraph(f'<font color={BLUE}>■</font> {category}', cell_style),
            "", "", "", "",
            Paragraph(f'<font color={LIGHT_BLUE}>■</font>', paid_style)
        ])
