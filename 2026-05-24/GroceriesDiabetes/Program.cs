...
class Program
{
    static void Main()
    {
        ...
        string fileTitle = "Diabetes Grocery List";
        string fileName = "diabetes_groceries";

        var columns = new List<DataColumn> { col1, col2, col3, col4, col5, col6 };

        strategy.Generate($"{fileName}_letter", fileTitle, PageSize.Letter, columns, theme);
        strategy.Generate($"{fileName}_a4", fileTitle, PageSize.A4, columns, theme);
